...
export default function AdminNewFontPage() {
  const router = useRouter();
  const pathname = '/admin/fonts/new';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.error || 'ফন্ট যোগ করতে সমস্যা হয়েছে');
      }
    } catch {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 z-40 flex items-center px-4">
        ...
        <h1 className="ml-3 text-lg font-bold text-[#d32f2f]">নতুন ফন্ট</h1>
      </header>
        ...
        <div className="p-6 lg:p-8 max-w-4xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              নতুন একটি বাংলা ফন্ট সিডিএন এ যোগ করুন
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <Card className="border-0 shadow-lg mb-6">
              <CardHeader>
                ...
                <CardDescription>ফন্টের প্রাথমিক তথ্য প্রদান করুন</CardDescription>
              </CardHeader>
            ...
            <Card className="border-0 shadow-lg mb-6">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="cssUrl">CSS URL * (স্বয়ংক্রিয় URL তৈরি হবে)</Label>
                  <Input
                    id="cssUrl"
